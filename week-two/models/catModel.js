...
const getAllCats = async (res) => {
  try {
    ...
    const sql = 'SELECT  cat_id, wop_cat.name, weight, owner, filename, birthdate, wop_ser.name AS ownername' + 'FROM wop_cat JOIN wop_user ON wop_cat.owner = wop_user.user_id';
